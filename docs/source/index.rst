...
Accessive is completely open-source and free to use and comes in three forms:
   ...
   - A `REST API <https://alexander.bio/accessive/api_doc.html>`_
...
mapping information from `Ensembl <https://ensembl.org>`_, `Uniprot <https://uniprot.org>`_, and `Nextprot <https://nextprot.org>`_.
